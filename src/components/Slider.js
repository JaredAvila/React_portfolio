          ...
          <li>
            ...
            <div class="caption center-align">
              ...
              <h5 class="hide-on-small-only">
                Our goal is to deliver beautiful, fully responsive, interactive,
                unique and modern products and services that will engage
                clients/customers.
              </h5>
              <a
                href="#contact"
          ...
          <li>
            ...
            <div class="caption right-align">
              ...
              <h5 class="light grey-text text-lighten-3 hide-on-small-only">
                ...
                Optimiztaion) friendly sites, social media mangement, marketing
                and more!
              </h5>
              <a
                href="/services"
